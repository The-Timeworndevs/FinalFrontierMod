...
public class FFBlocks {
    ...
    public static final Block MOONSTONE = register("moonstone", Block::new, AbstractBlock.Settings.create().sounds(BlockSoundGroup.STONE).strength(1.5f, 6).requiresTool(), true);
    public static final Block MOONSTONE_IRON_ORE = register("moonstone_iron_ore", Block::new, AbstractBlock.Settings.create().sounds(BlockSoundGroup.STONE).strength(3, 3).requiresTool(), true);
